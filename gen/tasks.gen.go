...
func (t *task) updateTableName(table string) *task {
	...
	t.Done = field.NewBool(table, "done")
...
func (t taskDo) Create(values ...*todo.Task) error {
	if len(values) == 0 {
		return nil
	}
...
func (t taskDo) CreateInBatches(values []*todo.Task, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t taskDo) Save(values ...*todo.Task) error {
	if len(values) == 0 {
		return nil
	}
...
func (t taskDo) First() (*todo.Task, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*todo.Task), nil
	}
}

func (t taskDo) Take() (*todo.Task, error) {
...
func (t taskDo) Last() (*todo.Task, error) {
...
func (t taskDo) Find() ([]*todo.Task, error) {
	result, err := t.DO.Find()
	return result.([]*todo.Task), err
}

func (t taskDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*todo.Task, err error) {
	buf := make([]*todo.Task, 0, batchSize)
...
func (t taskDo) FindInBatches(result *[]*todo.Task, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t taskDo) FirstOrInit() (*todo.Task, error) {
...
func (t taskDo) FirstOrCreate() (*todo.Task, error) {
...
func (t taskDo) FindByPage(offset int, limit int) (result []*todo.Task, count int64, err error) {
...
func (t taskDo) Delete(models ...*todo.Task) (result gen.ResultInfo, err error) {
